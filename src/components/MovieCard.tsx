        ...
        <>
            ...
            {expandedView && (
                <div className="fixed inset-0 bg-black/70 z-50 flex justify-center items-center p-4">
                    <div className="relative bg-white rounded-lg w-2/3 overflow-y-auto shadow-lg p-6">
                        <button
                            className="absolute top-2 right-3 text-gray-600 hover:text-black hover:cursor-pointer"
